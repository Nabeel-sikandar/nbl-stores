// Checkout Page — Cart + Buy Now + Coupon Code support
    ...
    return (
      <div className={`checkout-page ${darkMode ? "checkout-dark" : ""}`}>
        ...
        <div className="order-confirmation">
          ...
          <p className="confirmation-text font-[Inter]">
  ...
  return (
    <div className={`checkout-page ${darkMode ? "checkout-dark" : ""}`}>
      ...
      <div className="checkout-content">
        <h1 className="checkout-heading font-[Playfair_Display]">
        ...
        <div className="checkout-layout">
          ...
          <div className="shipping-section">
            ...
            <form onSubmit={handlePlaceOrder} className="shipping-form">
              <div className="input-group">
                ...
                <input type="text" name="fullName" value={shippingData.fullName} onChange={handleChange} placeholder="Enter your full name" className="input-field font-[Inter]" required />
              </div>

              <div className="input-group">
                <label className="input-label font-[Inter]">Phone Number</label>
                <input type="tel" name="phone" value={shippingData.phone} onChange={handleChange} placeholder="03XX-XXXXXXX" className="input-field font-[Inter]" required />
              </div>

              <div className="input-group">
                <label className="input-label font-[Inter]">Address</label>
                <textarea name="address" value={shippingData.address} onChange={handleChange} placeholder="Enter your full address" className="input-textarea font-[Inter]" rows="3" required></textarea>
              </div>

              <div className="input-row">
                <div className="input-group">
                  <label className="input-label font-[Inter]">City</label>
                  <input type="text" name="city" value={shippingData.city} onChange={handleChange} placeholder="City" className="input-field font-[Inter]" required />
                </div>
                <div className="input-group">
                  <label className="input-label font-[Inter]">Postal Code</label>
                  <input type="text" name="postalCode" value={shippingData.postalCode} onChange={handleChange} placeholder="Postal code" className="input-field font-[Inter]" />
                </div>
              </div>
              ...
              <div className="payment-section">
                ...
                <div className="payment-option">
                  <div className="payment-radio">
                    <input type="radio" id="cod" name="payment" defaultChecked className="radio-input" />
                    <label htmlFor="cod" className="payment-label font-[Inter]">Cash on Delivery (COD)</label>
                  </div>
                  <p className="payment-desc font-[Inter]">Pay when your order is delivered to your doorstep.</p>
                </div>
              </div>

              <button type="submit" className="place-order-btn font-[Inter]" disabled={loading}>
          ...
          <div className="checkout-summary">
            <h2 className="section-title font-[Inter]">
              Order Summary {isBuyNow && <span style={{ fontSize: "0.75rem", color: "#9ca3af" }}>(Quick Buy)</span>}
            </h2>
              ...
              {checkoutItems.map((item, index) => (
                <div key={index} className="summary-item">
                  ...
                  <div className="summary-item-info">
                    <p className="summary-item-title font-[Inter]">{item.title}</p>
                    <p className="summary-item-meta font-[Inter]">Size: {item.size} × {item.quantity}</p>
                  </div>
              ...
              {couponApplied ? (
                <div className="coupon-applied">
                  <div className="coupon-badge">
                    <span className="coupon-code-text font-[Inter]">{couponApplied.code}</span>
                    <span className="coupon-discount-text font-[Inter]">-{couponApplied.discount}%</span>
                  </div>
                ...
                <div className="coupon-input-row">
                  <input
                    ...
                    className="coupon-input font-[Inter]"
                  />
                  <button
                    type="button"
                    onClick={handleApplyCoupon}
                    className="coupon-apply-btn font-[Inter]"
            ...
            <div className="summary-row">
              ...
              <span className="summary-value font-[Inter]">Rs. {checkoutSubtotal}</span>
            </div>

            {couponApplied && (
              <div className="summary-row discount-row">
                <span className="summary-label font-[Inter]">Discount ({couponApplied.discount}%)</span>
                <span className="summary-value discount-value font-[Inter]">- Rs. {discountAmount}</span>
              </div>
            )}

            <div className="summary-row">
              <span className="summary-label font-[Inter]">Shipping</span>
              <span className="summary-value font-[Inter]">{shippingFee === 0 ? "FREE" : `Rs. ${shippingFee}`}</span>
            </div>
            <div className="summary-divider"></div>
            <div className="summary-row summary-total-row">
              <span className="summary-label font-[Inter]">Total</span>
              <span className="summary-value font-[Inter]">Rs. {total}</span>
            </div>
          </div>
        </div>
      </div>
